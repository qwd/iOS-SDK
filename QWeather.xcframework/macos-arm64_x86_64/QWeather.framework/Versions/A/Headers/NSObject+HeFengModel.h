//
//  NSObject+HeFengModel.h
//  HeFengModel <https://github.com/ibireme/HeFengModel>
//
 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `HeFengModel` protocol for custom methods.
 
 
 Sample Code:
    
     ********************** json convertor *********************
     @interface HeFengAuthor : NSObject
     @property (nonatomic, strong) NSString *name;
     @property (nonatomic, assign) NSDate *birthday;
     @end
     @implementation HeFengAuthor
     @end
 
     @interface HeFengBook : NSObject
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) NSUInteger pages;
     @property (nonatomic, strong) HeFengAuthor *author;
     @end
     @implementation HeFengBook
     @end
    
     int main() {
         // create model from json
         HeFengBook *book = [HeFengBook HeFeng_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book HeFeng_modelToJSONString];
         // {"author":{"name":"J.K.Rowling","birthday":"1965-07-31T00:00:00+0000"},"name":"Harry Potter","pages":256}
     }
 
     ********************** Coding/Copying/hash/equal *********************
     @interface HeFengShadow :NSObject <NSCoding, NSCopying>
     @property (nonatomic, copy) NSString *name;
     @property (nonatomic, assign) CGSize size;
     @end
 
     @implementation HeFengShadow
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self HeFeng_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self HeFeng_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self HeFeng_modelCopy]; }
     - (NSUInteger)hash { return [self HeFeng_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self HeFeng_modelIsEqual:object]; }
     @end
 
 */
@interface NSObject (HeFengModel)
 ...
 */
+ (nullable instancetype)HeFeng_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> NSDate, parsed with format "HeFengHeFeng-MM-dd'T'HH:mm:ssZ", "HeFengHeFeng-MM-dd HH:mm:ss" or "HeFengHeFeng-MM-dd".
     `NSString` -> NSURL.
     `NSValue` -> struct or union, such as CGRect, CGSize, ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)HeFeng_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)HeFeng_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)HeFeng_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)HeFeng_modelToJSONObject;
 ...
 */
- (nullable NSData *)HeFeng_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)HeFeng_modelToJSONString;
 ...
 */
- (void)HeFeng_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)HeFeng_modelInitWithCoder:(NSCoder *)aDecoder;
 ...
 */
- (BOOL)HeFeng_modelIsEqual:(id)model;
 ...
 */
- (NSString *)HeFeng_modelDescription;
 ...
 */
+ (nullable NSArray *)HeFeng_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (HeFengModel)
 ...
 */
+ (nullable NSDictionary *)HeFeng_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<HeFengModel>' to your class header.
 */
@protocol HeFengModel <NSObject>
@optional
...
/**
 ...
 object will be add to the array/set/dictionary.
  ...
  Example:
        @class HeFengShadow, HeFengBorder, HeFengAttachment;
 
        @interface HeFengAttributes
        @property NSString *name;
        ...
        @implementation HeFengAttributes
        + (NSDictionary *)modelContainerPropertyGenericClass {
            return @{@"shadows" : [HeFengShadow class],
                     @"borders" : HeFengBorder.class,
                     @"attachments" : @"HeFengAttachment" };
        }
        @end
...
/**
 ...
 Example:
        @class HeFengCircle, HeFengRectangle, HeFengLine;
 
        @implementation HeFengShape

        + (Class)modelCustomClassForDictionary:(NSDictionary*)dictionary {
            if (dictionary[@"radius"] != nil) {
                return [HeFengCircle class];
            } else if (dictionary[@"width"] != nil) {
                return [HeFengRectangle class];
            } else if (dictionary[@"y2"] != nil) {
                return [HeFengLine class];
            } else {
                return [self class];
            }
        }
