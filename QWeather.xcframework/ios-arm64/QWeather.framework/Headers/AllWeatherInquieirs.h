...
typedef NS_ENUM(NSInteger, INQUIRE_TYPE) {
    ...
    INQUIRE_TYPE_AIRQUALITY_NOW,//实时空气质量(new)
    INQUIRE_TYPE_AIRQUALITY_HOURLY,//空气质量小时预报(new)
    INQUIRE_TYPE_AIRQUALITY_DAILY,//空气质量每日预报(new)
    INQUIRE_TYPE_AIRQUALITY_STATION,//监测站数据(new)
